  ...
  definitions: {
    ...
    product: {
      ...
      properties: {
        ...
        purchase_order_details: {
          type: 'array',
          items: {
            $ref: '#/definitions/purchase_order_detail',
          },
        },
      },
    },
    order_detail: {
      ...
      properties: {
        ...
        status: {
          $ref: '#/definitions/order_details_status',
        },
        product: {
    ...
    order: {
      ...
      properties: {
        ...
        status: {
          $ref: '#/definitions/orders_status',
        },
        tax_status: {
          $ref: '#/definitions/orders_tax_status',
        },
        shipper: {
    ...
    inventory_transaction: {
      ...
      properties: {
        ...
        transaction_type: {
          $ref: '#/definitions/inventory_transaction_type',
        },
        purchase_order_details: {
          type: 'array',
          items: {
    ...
    purchase_order: {
      ...
      properties: {
        ...
        status: {
          $ref: '#/definitions/purchase_order_status',
        },
        supplier: {
