...
describe('typescript writer', () => {
  ...
  test('write datatypes with split and content header', async () => {
    write({
      sources: generatedDatatypes,
      formatterOptions: { semi: false, singleQuote: true },
      split: true,
      target: 'tests/.last_results/typescript/writer/split/datatypes-header',
      override: true,
      fileContentTransformer: (_, content) =>
        `// This file is generated with archite\n// Please do not edit this file directly\n\n${content}`,
    })
  })
